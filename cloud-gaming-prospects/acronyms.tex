...
\newacronym{DANE}{DANE}{\acrshort{DNS}-Based Authentication of Named Entities}
...
\newacronym{QUIC}{QUIC}{Quick \acrshort{UDP} Internet Connections}
...
\newacronym{uTP}{µTP}{Micro Transport Protocol}
